...
import com.gempukku.context.initializer.inject.property.PropertyResolver
...
private val log: Logger = Logger.getLogger(AnnotationSystemInitializer::class.java.name)

class AnnotationSystemInitializer(
    ...
    override fun processSystems(context: GempukkuContext, systems: Collection<Any>) {
        systems.forEach { system ->
            ...
            do {
                processSystem(context, system, classToInspect!!)
    ...
    private fun processSystem(context: GempukkuContext, system: Any, clazz: Class<Any>) {
